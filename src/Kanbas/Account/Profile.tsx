...
export default function Profile() {
  return (
    <div id="wd-profile-screen">
      ...
      className="form-control mb-2"/>
      <input id="wd-dob" value="mm/dd/yyyy" type="date" 
      className="form-control mb-2"/>
      <input id="wd-email" value="alice@wonderland.com" type="email" 
      className="form-control mb-2"/>
      ...
      className="btn btn-danger btn-primary w-100">Sign out</Link>
    </div>
);}